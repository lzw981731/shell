...
program_version_link="https://dl-web.dropbox.com/s/o3vkapuc1g9boln/version.sh"
str_install_shell=https://dl-web.dropbox.com/s/4c3gd1zxklsw98a/install-frps.sh
shell_update(){
    fun_clangcn "clear"
...
fun_getVer(){
    ...
    program_latest_filename="frp_0.33.0_linux_amd64.tar.gz"
    program_latest_file_url="https://github.com/lzw981731/frp/releases/download/0.33.0/frp_0.33.0_linux_amd64.tar.gz"
